...
DELIMITER //
CREATE PROCEDURE check_time_list (OUT returnID varchar(100))
BEGIN
    DECLARE result_doctor varchar(10) DEFAULT "";
...
DROP PROCEDURE IF EXISTS check_time_list;

SET @returnID = "";
CALL check_time_list(@returnID);
SELECT @returnID;